...
class MyCIFAR10(CIFAR10):
    ...
    def __init__(self, root, train=True, transform=None,
        ...
        super(MyCIFAR10, self).__init__('data', train, transform, target_transform, download)
...
class SequentialCIFAR10(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MyCIFAR10('data', train=True,
    ...
    def get_test_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), SequentialCIFAR10.TEST_TRANSFORM])
        return transform
    ...
    def get_normalization_transform():
        transform = transforms.Normalize((0.4914, 0.4822, 0.4465),
                                         (0.2470, 0.2435, 0.2615))
        # transform = transforms.Normalize((0., 0., 0.),
        #                                  (1., 1., 1.))
        return transform

...
class SequentialTinyImagenet(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MyTinyImagenet('/home/liangys/data/tiny-imagenet-processed',
                                 train=True, download=True, transform=transform)
        if self.args.validation:
            train_dataset, test_dataset = get_train_val(train_dataset,
                                                    test_transform, self.NAME)
        else:
            test_dataset = TinyImagenet('/home/liangys/data/tiny-imagenet-processed',
    ...
    def get_te_transform(self):
        transform = transforms.Compose(
            [transforms.ToPILImage(), SequentialTinyImagenet.TEST_TRANSFORM])
        return transform
